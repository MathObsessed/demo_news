...
class NewsFixtures extends Fixture {
    public function load(ObjectManager $manager) {
        ...
        $news1
            ...
            ->setThumbnail('domain_model_thumb.jpg')
            ->setImage('domain_model.png')
        ...
        $news3
            ...
            ->setTitle('Clean Code')
            ->setThumbnail('clean_code_thumb.jpg')
            ->setImage('clean_code.png')
        ...
        $news5
            ...
            ->setThumbnail('continuous_integration_thumb.png')
            ->setImage('continuous_integration.png')
