...
class NewsFixtures extends Fixture {
    public function load(ObjectManager $manager) {
        ...
        $news1
            ...
            ->setThumbnail('/assets/domain_model_thumb.jpg')
            ->setImage('/assets/domain_model.png')
        ...
        $news2
            ...
            ->setThumbnail('/assets/bdd_thumb.png')
            ->setImage('/assets/bdd.png')
        ...
        $news3
            ...
            ->setTitle('Clean Code')
            ->setThumbnail('/assets/clean_code_thumb.jpg')
            ->setImage('/assets/clean_code.png')
        ...
        $news4
            ...
            ->setTitle('Docker')
            ->setThumbnail('/assets/docker_thumb.png')
            ->setImage('/assets/docker.png')
        ...
        $news5
            ...
            ->setThumbnail('/assets/continuous_integration_thumb.png')
            ->setImage('/assets/continuous_integration.png')
